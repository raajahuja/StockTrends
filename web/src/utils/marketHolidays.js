export const MARKET_HOLIDAYS = {
    ...
    '2017-10-19': 'Dussehra/Diwali Laxmi Pujan',
    ...
    '2026-10-20': 'Dussehra',
    '2026-11-08': 'Diwali Laxmi Pujan (Sun)',
...
/**
 * Checks if a given date is a market holiday or weekend in India.
 * @param {Date|string} dateInput - Date object or ISO string to check
 * @returns {boolean} - True if closed, false if open
 */
export const isMarketClosed = (dateInput) => {
    let dateObj;
    ...
    // Use UTC date for consistent holiday checking if passed an ISO string
    // Or convert to IST date string for checking
...
/**
 * Gets current IST date string (YYYY-MM-DD)
 */
